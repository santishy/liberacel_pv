<template>
    <nav-component>
        <div class="w-9/12 mx-auto shadow  pb-4 bg-white rounded-sm">
            <h1 class=" text-gray-800  text-center border-b-2 border-gray-300 py-3 text-2xl font-extralight">
                Reporte de {{ name }}
            </h1>
        ...
        <payment-list :uri="uri" :name="name"> </payment-list>
    </nav-component>
</template>
<script>
...
export default {
    components: { ReportBy, NavComponent, ErrorsComponent, PaymentList, WarehouseChecklist },
    props: {
        name: {
            type: String
        },
