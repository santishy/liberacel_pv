<template>
    <div class="flex flex-wrap flex-col items-start justify-start">
        ...
        <div class="flex justify-start gap-4 flex-wrap items-center w-full">
            ...
            <div class="w-full flex flex-wrap justify-start gap-4 ">
                <div
                    class="p-1 border bg-orange-100 w-full sm:w-auto overflow-x-hidden items-center gap-2 justify-center rounded text-slate-700 font-mono px-3 flex flex-row flex-wrap">
                ...
                <button class="report-button sm:w-auto w-full px-4 py-2" @click.prevent="getReport(today)">
                    Hoy
                </button>
                <button class="report-button px-4 sm:w-auto w-full py-2" href="#"
                    @click.prevent="getReport(fridayToThursday)">
                    Viernes a Jueves
                </button>
                <button class="report-button px-4 py-2 sm:w-auto w-full" href="#" @click.prevent="getReport(week)">
                    Semana
                </button>
                <button class="px-4 py-2 report-button sm:w-auto w-full" href="#" @click.prevent="getReport(month)">
                    Mes
                </button>
            </div>
        </div>
