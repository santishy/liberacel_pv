...
import ReportBy from "../reports/ReportBy.vue";
import NavComponent from "../NavComponent.vue";
import ErrorsComponent from "../ErrorsComponent.vue";
import ListOfProductsSold from "../fast-sales/ListOfProductsSold.vue";

export default {
    components: { ReportBy, NavComponent ,ErrorsComponent,ListOfProductsSold},
    data() {
        return {
            total: null
        };
