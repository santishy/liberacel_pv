<template>
    <aside :class="[isOpen ? 'w-72' : 'w-10']" @mouseenter="isOpen=true" @mouseleave="closeDropdown"
        ...
        <div class="w-full overflow-x-hidden overflow-y-auto ">
            ...
            <dropdown class="mt-4" title="Expres" :menu="ExpressMenu" title-font-color="text-purple-100"
                item-font-color="text-gray-700">
                <template slot="icon">
            ...
            <dropdown class="mt-4" title="Egresos" :menu="ExpensesMenu" title-font-color="text-purple-100"
                item-font-color="text-gray-700">
                <template slot="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6">
            ...
            <dropdown class="mt-4" title="Clientes" :menu="clientsMenu" title-font-color="text-purple-100"
                item-font-color="text-gray-700">
                <template slot="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6">
            ...
            <dropdown class="mt-4" title="Configuración" :menu="ConfigMenu" title-font-color="text-purple-100"
                item-font-color="text-gray-700">
                <template slot="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6">
