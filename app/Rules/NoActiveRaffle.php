...
class NoActiveRaffle implements ValidationRule
{
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        ...
        /*
            ...
            entonces si el ID enviado, valida que este activa una rifa y sea diferente de el id que se mando entonces invalida la accion por que ya hay una rifa activa
        */
